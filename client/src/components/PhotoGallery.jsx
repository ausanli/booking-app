  ...
  if (showAllPhotos) {
    return (
      <div className="absolute inset-0 bg-black text-white min-w-full min-h-screen">
        <div className="flex justify-center bg-black p-8 grid gap-4">
          <div>
            <h2 className="text-3xl mr-48 text-center mb-4 ">
              Photos of {place.title}{" "}
            </h2>
            <button
              onClick={() => setShowAllPhotos(false)}
              className="fixed right-12 top-8 flex gap-1 py-2 px-4 rounded-2xl text-black bg-white shadow shadow-black"
            >
              <svg
